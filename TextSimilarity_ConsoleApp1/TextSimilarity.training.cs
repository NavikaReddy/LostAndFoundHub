...
namespace TextSimilarity_ConsoleApp1
{
    public partial class TextSimilarity
    {
        public const string RetrainFilePath =  @"C:\Users\navik\OneDrive\Documents\textSimilarity.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Regression.Trainers.SentenceSimilarity(labelColumnName: @"Similarity", sentence1ColumnName: @"Desc1", sentence2ColumnName:@"Desc2");
